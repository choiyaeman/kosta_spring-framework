...
public class Test {
	...
	public static void main(String[] args) {
		...
		//System.out.println(com.my.vo.RepBoard.class instanceof Class); //참조변수가 참조하고 있는 인스턴스의 실제 타입을 알아보기 위해 instanceof 연산자를 사용
...
//		RepBoardDAO dao = ctx.getBean("dao", com.my.dao.RepBoardDAO.class);
//		System.out.println(dao);
		RepBoardService service = 
				ctx.getBean("service", com.my.service.RepBoardService.class);
	}
